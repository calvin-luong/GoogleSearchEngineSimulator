...
/**
 * Uses the Google search engine to look for a key word.
 *
 * @author       Ching-seh Wu Copyright (2019)
 * @version      1.0
 */
...
public class WebCrawler {
	...
	public String getDomainName(String url) {
		...
		if (url.startsWith("/url?q=https://")) {
			return url.substring(15, 50); //formerly 42
		}
		return url.substring(14, 50);
	}
